...
namespace Control
{
    public class ctrConsultorio
    {
        public static bool registrarConsultorio(clsConsultorio objConsultorio)
        {
            ...
            int numResultado = clsGestorBD.ejecutarStoredProcedure("up_ManConsultorio", lstParametrosSQL);
        ...
        public static clsConsultorio seleccionarConsultorio(clsConsultorio objConsultorio)
        {
            ...
            DataTable dtResultado = clsGestorBD.ejecutarStoredProcedure2("up_ManConsultorio", lstParametrosSQL);
        ...
        public static DataTable seleccionarConsultorios(clsConsultorio objConsultorio)
        {
            ...
            return clsGestorBD.ejecutarStoredProcedure2("up_ManConsultorio", lstParametrosSQL);
        }
