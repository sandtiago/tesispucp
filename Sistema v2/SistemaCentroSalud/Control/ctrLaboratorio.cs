...
namespace Control
{
    public class ctrLaboratorio
    {
        public static bool registrarLaboratorio(clsLaboratorio objLaboratorio)
        {
            ...
            int numResultado = clsGestorBD.ejecutarStoredProcedure("up_ManLaboratorio", lstParametrosSQL);
        ...
        public static clsLaboratorio seleccionarLaboratorio(clsLaboratorio objLaboratorio)
        {
            ...
            DataTable dtResultado = clsGestorBD.ejecutarStoredProcedure2("up_ManLaboratorio", lstParametrosSQL);
        ...
        public static DataTable seleccionarLaboratorioes(clsLaboratorio objLaboratorio)
        {
            ...
            return clsGestorBD.ejecutarStoredProcedure2("up_ManLaboratorio", lstParametrosSQL);
        }
