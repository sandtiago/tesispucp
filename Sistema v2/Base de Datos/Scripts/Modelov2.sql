...
( 
	...
	AntiguoValor         varchar(100)  NOT NULL ,
...
ALTER TABLE Auditoria
	ADD CONSTRAINT XPKAuditoria PRIMARY KEY (IdAuditoria ASC)
go
...
CREATE TABLE TablaAuditada
( 
	IdTablaAuditada      int IDENTITY ( 1,1 ) ,
	Tabla                varchar(100)  NOT NULL ,
	Insertar             char(1)  NOT NULL ,
	Actualizar           char(1)  NOT NULL ,
	Eliminar             char(1)  NOT NULL ,
	IndAuditoria         char(1)  NOT NULL 
)
go



ALTER TABLE TablaAuditada
	ADD CONSTRAINT XPKTablaAuditada PRIMARY KEY (IdTablaAuditada ASC)
go
...
ALTER TABLE Diagnostico
	ADD CONSTRAINT R_76 FOREIGN KEY (IdEpisodio) REFERENCES Episodio(IdEpisodio)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
