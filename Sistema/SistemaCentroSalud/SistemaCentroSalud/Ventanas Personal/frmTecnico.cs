...
namespace SistemaCentroSalud.Ventanas_Personal
{
    public partial class frmTecnico : Form
    {
        ...
        {
            InitializeComponent();
            clsComun.redimensionarVentana(this, 490, 444);            
        }
        ...
        private void frmTecnico_Load(object sender, EventArgs e)
        {
            ...
            inicializarVentana();
            dtTecnico = clsGestorBD.up_SelTecnico(0, "", "", "", "", "", clsGestorBD.SELECTALL);
            llenarGrilla(dtTecnico);
        }
        ...
        private void llenarGrilla(DataTable dtTabla)
        {
            ...
            {
                string strIdTecnico = dtTabla.Rows[i][0].ToString();
                ...
                string strEstadoTecnico = dtTabla.Rows[i][5].ToString();

                string[] strFila = { strIdTecnico, strPaterno, strMaterno, strNombres, strArea, strEstadoTecnico };

                dgvTecnicos.Rows.Add(strFila);

                if (strEstadoTecnico.CompareTo("INACTIVO") == 0)
                {
                    dgvTecnicos.Rows[i].Cells[0].Style.ForeColor = Color.White;
                    dgvTecnicos.Rows[i].Cells[0].Style.BackColor = Color.Red;
                    ...
                    dgvTecnicos.Rows[i].Cells[5].Style.ForeColor = Color.White;
                    dgvTecnicos.Rows[i].Cells[5].Style.BackColor = Color.Red;
                }
            }
        }
            ...
            if (txtPaterno.Text.CompareTo("") != 0)
            {
                if (txtMaterno.Text.CompareTo("") != 0)
                {
                    if (txtNombres.Text.CompareTo("") != 0)
                    {
                        if (cboEstadoCivil.Text.CompareTo("SELECCIONAR") != 0)
                        {
                            if (cboSexo.Text.CompareTo("SELECCIONAR") != 0)
                            {
                                if (validarFecha(dtpFechaNacimiento.Value))
                                {
                                    if (cboTipoDocumento.Text.CompareTo("SELECCIONAR") != 0)
                                    {
                                        if (txtNumeroDocumento.Text.CompareTo("") != 0)
                                        {
                                            ...
                                            //{
                                                        ...
                                                        //{
                                                            if (cboPerfil.Text.CompareTo("SELECCIONAR") != 0)
                                                            {
                                                                if (cboPais.Text.CompareTo("SELECCIONAR") != 0)
                                                                {
                                                                    if (cboDepartamento.Text.CompareTo("SELECCIONAR") != 0)
                                                                    {
                                                                        if (cboProvincia.Text.CompareTo("SELECCIONAR") != 0)
                                                                        {
                                                                            if (cboDistrito.Text.CompareTo("SELECCIONAR") != 0)
                                                                            {
                                                                                if (cboDepartamentoDomicilio.Text.CompareTo("SELECCIONAR") != 0)
                                                                                {
                                                                                    if (cboProvinciaDomicilio.Text.CompareTo("SELECCIONAR") != 0)
                                                                                    {
                                                                                        if (cboDistritoDomicilio.Text.CompareTo("SELECCIONAR") != 0)
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                                MessageBox.Show("Debe ingresar la dirección del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                                                txtDireccion.Focus();
                                                                                                return false;
                                                                                            }
                                                                                        }
                                                                                        ...
                                                                                        {
                                                                                            MessageBox.Show("Debe seleccionar el distrito de domicilio del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                                    ...
                                                                                    {
                                                                                        MessageBox.Show("Debe seleccionar la provincia de domicilio del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                                ...
                                                                                {
                                                                                    MessageBox.Show("Debe seleccionar el departamento de domicilio del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                            ...
                                                                            {
                                                                                MessageBox.Show("Debe seleccionar el distrito de nacimiento del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                                cboDistrito.Focus();
                                                                                return false;
                                                                            }
                                                                        }
                                                                        ...
                                                                        {
                                                                            MessageBox.Show("Debe seleccionar la provincia de nacimiento del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                            cboProvincia.Focus();
                                                                            return false;
                                                                        }
                                                                    }
                                                                    ...
                                                                    {
                                                                        MessageBox.Show("Debe seleccionar el departamento de nacimiento del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                ...
                                                                {
                                                                    MessageBox.Show("Debe seleccionar el pais de nacimiento del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                    cboPais.Focus();
                                                                    return false;
                                                                }
                                                            }
                                                            ...
                                                            {
                                                                MessageBox.Show("Debe seleccionar el perfil del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                                cboPerfil.Focus();
                                                                return false;
                                                            }
                                                        //}
                                                ...
                                                {
                                                    MessageBox.Show("Debe seleccionar el área del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                                    cboArea.Focus();
                                                    return false;
                                                }
                                            //}
                                        ...
                                        {
                                            MessageBox.Show("Debe ingresar el número de documento del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                            txtNumeroDocumento.Focus();
                                            return false;
                                        }
                                    }
                                    ...
                                    {
                                        MessageBox.Show("Debe seleccionar el tipo de documento del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            ...
                            {
                                MessageBox.Show("Debe seleccionar el sexo del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                cboSexo.Focus();
                                return false;
                            }
                        }
                        ...
                        {
                            MessageBox.Show("Debe seleccionar el estado civil del técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void btnVer_Click(object sender, EventArgs e)
        {
            if (dgvTecnicos.SelectedRows.Count > 0)
            {
                try
                {
                    ...
                    DataTable dtTecnico = clsGestorBD.up_SelTecnico(numIdTecnico, "", "", "", "", "", clsGestorBD.SELECT);

                    mostrarDatos(numAccion, dtTecnico);
        ...
        {
            limpiarCampos();
            DataTable dtTemporal = clsGestorBD.up_SelTecnico(0, "", "", "", "", "", clsGestorBD.SELECTALL);
            llenarGrilla(dtTemporal);

            clsComun.tabAnterior(tbcTecnico, tbpBuscar, tbpDetalle);
            clsComun.redimensionarTabControl(tbcTecnico, 572, 416);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (validarVentana())
            {
                ...
                else
                {
                    if (numAccion == clsGestorBD.INSERT)
                    {
                        MessageBox.Show("Ocurrió un error mientras se intentaba registrar al técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        MessageBox.Show("Ocurrió un error mientras se intentaba actualizar al técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        }
        ...
        {
            if (dgvTecnicos.Rows[dgvTecnicos.CurrentRow.Index].Cells[5].Value.ToString().CompareTo("ACTIVO") == 0)
            {
        ...
        {
            if (dgvTecnicos.RowCount > 0)
            {
                try
                {
                    numIdTecnico = Int32.Parse(dgvTecnicos.Rows[dgvTecnicos.CurrentRow.Index].Cells[0].Value.ToString());
                    if (clsGestorBD.up_ManTecnico(numIdTecnico, "", "", "", "", dtpFechaNacimiento.Value, 0, "", "", "", "", "", "", "", "", "", "", "", "", "", DateTime.Now, "", "", "", "", 0, 0, "", clsGestorBD.RECOVER))
                    {
                    ...
                    {
                        MessageBox.Show("Ocurrió un error mientras se intentaba activar al técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
        ...
        private void btnInactivar_Click(object sender, EventArgs e)
        {
            if (dgvTecnicos.RowCount > 0)
            {
                ...
                {
                    numIdTecnico = Int32.Parse(dgvTecnicos.Rows[dgvTecnicos.CurrentRow.Index].Cells[0].Value.ToString());
                    if (clsGestorBD.up_ManTecnico(numIdTecnico, "", "", "", "", dtpFechaNacimiento.Value, 0, "", "", "", "", "", "", "", "", "", "", "", "", "", DateTime.Now, "", "", "", "", 0, 0, "", clsGestorBD.DELETE))
                    {
                        MessageBox.Show("El técnico se inactivó exitosamente", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        MessageBox.Show("Ocurrió un error mientras se intentaba inactivar al técnico", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
